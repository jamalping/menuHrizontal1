...
@protocol BallClickDelegate <NSObject>
-(void)ballViewClick:(UIButton *)button;
@end
...
@property (nonatomic,retain) NSMutableArray *contentItems;  // 存放表视图的数组

@property (nonatomic,assign) id<ScrollPageViewDelegate> delegate;

@property (nonatomic,assign) id<BallClickDelegate> btnDelegate;
